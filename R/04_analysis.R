...
#' Fit Nested Random Effects Models
#'
#' Robustness check fitting nested random intercepts at all three geographic
#' levels, rather than the buurt-only random intercept of the main models.
#'
...
fit_nested_random_effects <- function(data) {
  ...
  message("Fitting nested random effects models...")
